...
// class DoctorBlogsListWidget extends StatefulWidget {
//   final String doctorBlogsSlug;
//   DoctorBlogsListWidget({
//     super.key,
//     required this.doctorBlogsSlug,
//   });

//   @override
//   State<DoctorBlogsListWidget> createState() => _DoctorBlogsListWidgetState();
// }

// class _DoctorBlogsListWidgetState extends State<DoctorBlogsListWidget> {
//   final logic = Get.put(DoctorReviewsController());

//   @override
//   void initState() {
//     super.initState();
//     postMethod(context, '$getDoctorReviews/${widget.doctorBlogsSlug}', null,
