      ...
      appBar: PreferredSize(
        ...
        child: AppBarWidget(
          ...
          leadingOnTap: () async {
            ...
            if (currentURL.toString().split("/").last.toString() == "doctor") {
              getMethod(Get.context!, "$getLoggedInUserUrl?logged_in_as=doctor",
          ...
          titleText: LanguageConstant.pricingPlan.tr,
        ),
      ),
