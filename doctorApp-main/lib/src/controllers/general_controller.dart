...
class GeneralController extends GetxController {
  ...
  RxBool isCallCompleted= false.obs;
...
// Get Generic Response Model
  ...
  GetLoggedInDoctorDataModel?
      currentDoctorModel; //  for saving all-generic-app-data
  ...
  Map<String, dynamic>? appointmentObject; // Full Object
  Map<String, dynamic>? appointmentFilteredObject; // Filtered Object
  ...
  DoctorAppointmentHistoryModel selectedAppointmentHistoryForView =
      DoctorAppointmentHistoryModel();
  updateSelectedAppointmentHistoryForView(
    DoctorAppointmentHistoryModel newValue,
  ) {
  ...
  DoctorBookedServiceModel selectedBookedServiceForView =
      DoctorBookedServiceModel();
  updateSelectedBookedServicesForView(
    DoctorBookedServiceModel newValue,
  ) {
