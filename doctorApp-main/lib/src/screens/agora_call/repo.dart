...
makeAgoraCallRepo(
  ...
  if (responseCheck) {
    ...
    postMethod(
        ...
        {
          "title":
              "${Get.find<GeneralController>().appointmentObject!["appointment_type_name"]} from Doctor",
          ...
          "reciever_id":
              Get.find<GeneralController>().appointmentObject!["patient_id"],
          "payload": {
            "appointment":
                Get.find<GeneralController>().appointmentFilteredObject,
            "channel_name": Get.find<GeneralController>().channelForCall,
