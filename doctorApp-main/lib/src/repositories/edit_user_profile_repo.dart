...
editUserProfileDataRepo(
  ...
  if (responseCheck) {
    if (response['success'].toString() == 'true') {
      ...
      log("${jsonEncode(Get.find<GeneralController>().currentDoctorModel)} Response Data 1.2");
      log("${jsonEncode(GetLoggedInDoctorDataModel.fromJson(response['data']))} Response Data 1.3");
      Get.find<GeneralController>().currentDoctorModel =
          GetLoggedInDoctorDataModel.fromJson(response);
      if (Get.find<GeneralController>().storageBox.hasData('userData')) {
        Get.find<GeneralController>().currentDoctorModel =
            GetLoggedInDoctorDataModel.fromJson(response['data']);
        Get.find<GeneralController>().storageBox.write('userData',
            jsonEncode(Get.find<GeneralController>().currentDoctorModel));
      }
...
editUserProfileImageRepo(
  ...
  dio_instance.FormData formData =
    ...
    "zip_code": zipCode,
    "doctor_categories[]": doctorCategories,
    "languages[]": languages,
    "tags[]": tags,
  ...
  setCustomHeader(dio, 'logged-in-as', 'doctor');
  ...
  try {
    ...
    if (response.statusCode == 200) {
      ...
      if (response.data['success'].toString() == 'true') {
        getMethod(Get.context!, getLoggedInUserUrl, {'login_as': "doctor"},
            true, loggedInUserRepo);
        Get.find<GeneralController>().currentDoctorModel =
            GetLoggedInDoctorDataModel.fromJson(response.data['data']);
        // Get.find<GeneralController>().storageBox.write('userData',
        //     jsonEncode(Get.find<GeneralController>().currentDoctorModel));
...
editUserProfileCertificateDataRepo(
  ...
  if (responseCheck) {
    if (response['success'].toString() == 'true') {
      Get.find<EditProfileController>().doctorProfileCertificateModel =
          DoctorProfileCertificateModel.fromJson(response);

      // Get.find<EditProfileController>().currentDoctorModel =
      //     GetLoggedInDoctorDataModel.fromJson(response['data']);
...
addUserProfileCertificateDataRepo(
  ...
  try {
    ...
    if (response.statusCode == 200) {
      if (response.data['success'].toString() == 'true') {
        Get.find<EditProfileController>().doctorProfileCertificateModel =
            DoctorProfileCertificateModel.fromJson(response.data);
        showDialog(
            context: Get.context!,
            barrierDismissible: false,
            builder: (BuildContext context) {
...
addUserProfileExperienceDataRepo(
  ...
  try {
    ...
    if (response.statusCode == 200) {
      if (response.data['success'].toString() == 'true') {
        Get.find<EditProfileController>().doctorProfileExperienceModel =
            DoctorProfileExperienceModel.fromJson(response.data);
        showDialog(
            context: Get.context!,
            barrierDismissible: false,
            builder: (BuildContext context) {
...
addUserProfileEducationDataRepo(
  ...
  try {
    ...
    if (response.statusCode == 200) {
      if (response.data['success'].toString() == 'true') {
        Get.find<EditProfileController>().doctorProfileEducationModel =
            DoctorProfileEducationModel.fromJson(response.data);
        showDialog(
            context: Get.context!,
            barrierDismissible: false,
            builder: (BuildContext context) {
...
addUserProfilePodcastDataRepo(
  ...
  try {
    ...
    if (response.statusCode == 200) {
      if (response.data['success'].toString() == 'true') {
        Get.find<EditProfileController>().doctorProfilePodcastModel =
            DoctorProfilePodcastModel.fromJson(response.data);
        showDialog(
            context: Get.context!,
            barrierDismissible: false,
            builder: (BuildContext context) {
