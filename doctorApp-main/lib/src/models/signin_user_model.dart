...
class User {
  ...
  User.fromJson(dynamic json) {
    ...
    _doctorModules = json['doctor_modules'] != null
        ...
        : [];
    _clinicModules = json['clinic_modules'] != null
        ? json['clinic_modules'].cast<String>()
        : [];
  ...
  Map<String, dynamic> toJson() {
    ...
    map['clinic_modules'] = _clinicModules;
...
class LoginInfo {
  ...
  LoginInfo.fromJson(dynamic json) {
    ...
    _pricingPlan = json['pricing_plan'] != null
  ...
  LoginInfo copyWith({
    ...
    String? updatedAt,
      ...
      LoginInfo(
        ...
        pricingPlan: pricingPlan ?? _pricingPlan,
        isActive: isActive ?? _isActive,
  ...
  PricingPlan? get pricingPlan => _pricingPlan;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (_pricingPlan != null) {
      map['pricing_plan'] = _pricingPlan?.toJson();
    }
    map['is_active'] = _isActive;
...
PricingPlan pricingPlanFromJson(String str) =>
    PricingPlan.fromJson(json.decode(str));
String pricingPlanToJson(PricingPlan data) => json.encode(data.toJson());
...
class PricingPlan {
  ...
  PricingPlan copyWith({
    ...
    dynamic deletedAt,
      ...
      PricingPlan(
        ...
        image: image ?? _image,
        color: color ?? _color,
        stripePlan: stripePlan ?? _stripePlan,
        price: price ?? _price,
        slug: slug ?? _slug,
  ...
  dynamic get stripePlan => _stripePlan;
