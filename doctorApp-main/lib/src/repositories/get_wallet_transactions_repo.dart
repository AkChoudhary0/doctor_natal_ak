...
getWalletTransactionsRepo(
  ...
  if (responseCheck) {
    ...
    log("${Get.find<WalletController>().getWalletTransactionsModel.data!.data!.length.toString()} Total Doctor Wallet Transactions Length");

    log("${Get.find<WalletController>().getWalletTransactionsModel.data!.data!} Only Data Doctor Wallet Transactions History");
