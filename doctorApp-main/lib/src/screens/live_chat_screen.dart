            ...
            appBar: PreferredSize(
              ...
              child: AppBarWidget(
                ...
                titleText: generalController
                    .selectedAppointmentHistoryForView.patientName!,
              ),
            ),
            body: Stack(
              children: [
                !liveChatController.getMessagesLoader
                    ? Padding(
                          ...
                          child: TextFormField(
                            ...
                            onTap: () {
                              Future.delayed(const Duration(seconds: 1))
                                  .whenComplete(() => liveChatController
                            ...
                            decoration: InputDecoration(
                              ...
                              hintStyle: AppTextStyles.bodyTextStyle11,
